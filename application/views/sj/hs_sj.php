		...
		<section>
			<div>
				<div>
					<table id="table_hide">
						<tr>
							<td><img src="<?php echo base_url(); ?>gambar/website/Logo-02.png"
						...
						<tr>
							<td width="30%">
								Komplek Pergudangan lio baru asri Blok C RT.7/RW.004 Batuceper, Kec Batuceper, Kota Tangerang,
								Banten
								15121<br></td>
							<td width="30%"></td>
							<td></td>
				...
				<div>
					<table id="table_hide">
						...
						<tr>
							...
							<td>Phone</td>
							<td> : </td>
							<td><?php echo preg_replace('/\d{3}/', '$0-', str_replace('.', 'null', trim($u->phone)), 1); ?>
							</td>
						</tr>
						<?php endforeach; ?>
					</table>
