	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form class="form-horizontal" onsubmit="addbtn.disabled = true; return true;" method="post"
				action="<?php echo base_url('sj/sj_aksi') ?>">
				<div class="modal-body">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="number" name="no_po" class="form-control" min="1" placeholder="Input No Po..."
								required>
...
<div class="modal fade" id="modal_edit_sj<?php echo $p->no_po; ?>" tabindex="-1" data-backdrop="static">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="col-12 modal-title text-center">Edit Surat Jalan
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</h4>
			...
			<form class="form-horizontal" onsubmit="editbtn.disabled = true; return true;" method="post"
				action="<?php echo base_url('sj/sj_edit') ?>">
				<div class="modal-body">
					<div class="form-group row">
						<label class="col-sm-2 col-form-label">No Do *</label>
						<div class="col-sm-10">
							<input type="text" name="no_delivery" class="form-control" value="<?php echo $p->no_delivery; ?>"
								readonly required>
							<?php echo form_error('no_delivery'); ?>
						</div>
					</div>
					...
					<div class="form-group row">
						<label class="col-sm-2 col-form-label">No Po *</label>
						<div class="col-sm-10">
							<input type="number" name="no_po" class="form-control" min="1" value="<?php echo $p->no_po; ?>"
								required>
							<?php echo form_error('no_po'); ?>
						</div>
					</div>
	...
	<div class="modal-dialog">
		<div class="modal-content bg-danger">
			...
			<form class="form-horizontal" onsubmit="delform.disabled = true; return true;" method="post"
				action="<?php echo base_url('sj/sj_hapus') ?>">
				<div class="modal-body">
