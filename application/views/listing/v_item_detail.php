					...
					<div class="col-md-6">
						<div class="card card-info">
								...
								<table id="example5" class="table table-hover table-sm">
									...
									foreach ($query->result() as $p) { ?>
										<tr style="text-align:center">
											...
											<td>
												<a class="btn-sm btn-warning" data-toggle="modal" data-target="#brand_edit<?php echo $p->id; ?>" title="Edit">
													<i class="fa fa-edit"></i></a>
												<a class="btn-sm btn-danger" data-toggle="modal" data-target="#brand_del<?php echo $p->id; ?>" title="Delete">
							...
							<div class="card-body row">
								<div class="col-md-4">
									<button class="btn btn-success btn-block" data-toggle="modal" data-target="#brand_add" title="Add"><i class="fa fa-plus"></i> Add New Brand</button>
								</div>
							</div>
						</div>
					</div>
				...
				<?php if (($b->nama == 'hose') || ($b->nama == 'fitting')) : ?>
					<div class="col-md-6">
						<div class="card card-info">
								...
								<table id="example3" class="table table-hover table-sm">
									...
									foreach ($query->result() as $p) { ?>
										<tr style="text-align:center">
											...
											<td><?php echo strtoupper($p->nama) ?></td>
											<td>
												<a class="btn-sm btn-warning" data-toggle="modal" data-target="#type_edit<?php echo $p->id; ?>" title="Edit">
													<i class="fa fa-edit"></i></a>
												<a class="btn-sm btn-danger" data-toggle="modal" data-target="#type_del<?php echo $p->id; ?>" title="Delete">
													<i class="fa fa-trash"></i></a>
											</td>
										</tr>
									<?php } ?>
							...
							<div class="card-body row">
								<div class="col-md-4">
									<button class="btn btn-success btn-block" data-toggle="modal" data-target="#type_add" title="Add"><i class="fa fa-plus"></i> Add New Type</button>
								</div>
							</div>
						</div>
					</div>
								...
								<table id="example2" class="table table-hover table-sm">
									...
									foreach ($query->result() as $p) { ?>
										<tr style="text-align:center">
											...
											<td><?php echo strtoupper($p->nama) ?></td>
											<td>
												<a class="btn-sm btn-warning" data-toggle="modal" data-target="#size_edit<?php echo $p->id; ?>" title="Edit">
													<i class="fa fa-edit"></i></a>
												<a class="btn-sm btn-danger" data-toggle="modal" data-target="#size_del<?php echo $p->id; ?>" title="Delete">
													<i class="fa fa-trash"></i></a>
											</td>
										</tr>
									<?php } ?>
				...
				<?php if (($b->nama == 'fitting') || ($b->nama == 'pipe')) : ?>
					<div class="col-md-6">
						<div class="card card-info">
								...
								<table id="example6" class="table table-hover table-sm">
									...
									foreach ($query->result() as $p) { ?>
										<tr style="text-align:center">
											...
											<td><?php echo strtoupper($p->nama) ?></td>
											<td>
												<a class="btn-sm btn-warning" data-toggle="modal" data-target="#model_edit<?php echo $p->id; ?>" title="Edit">
													<i class="fa fa-edit"></i></a>
												<a class="btn-sm btn-danger" data-toggle="modal" data-target="#model_del<?php echo $p->id; ?>" title="Delete">
													<i class="fa fa-trash"></i></a>
											</td>
										</tr>
									<?php } ?>
							...
							<div class="card-body row">
								<div class="col-md-4">
									<button class="btn btn-success btn-block" data-toggle="modal" data-target="#model_add" title="Add">
								...
								<table id="example1" class="table table-hover table-sm">
									...
									foreach ($query->result() as $p) { ?>
										<tr style="text-align:center">
											...
											<td><?php echo strtoupper($p->nama) ?></td>
											<td>
												<a class="btn-sm btn-warning" data-toggle="modal" data-target="#od_edit<?php echo $p->id; ?>" title="Edit">
													<i class="fa fa-edit"></i></a>
												<a class="btn-sm btn-danger" data-toggle="modal" data-target="#od_del<?php echo $p->id; ?>" title="Delete">
													<i class="fa fa-trash"></i></a>
											</td>
										</tr>
									<?php } ?>
				...
				<?php if (($b->nama == 'hose cover') || ($b->nama == 'fitting')) : ?>
					<div class="col-md-6">
						<div class="card card-info">
								...
								<table id="example7" class="table table-hover table-sm">
									...
									foreach ($query->result() as $p) { ?>
										<tr style="text-align:center">
											...
											<td><?php echo strtoupper($p->nama) ?></td>
											<td>
												<a class="btn-sm btn-warning" data-toggle="modal" data-target="#category_edit<?php echo $p->id; ?>" title="Edit">
													<i class="fa fa-edit"></i></a>
												<a class="btn-sm btn-danger" data-toggle="modal" data-target="#category_del<?php echo $p->id; ?>" title="Delete">
													<i class="fa fa-trash"></i></a>
											</td>
										</tr>
									<?php } ?>
							...
							<div class="card-body row">
								<div class="col-md-4">
									<button class="btn btn-success btn-block" data-toggle="modal" data-target="#category_add" title="Add"><i class="fa fa-plus"></i> Add New Category</button>
								</div>
							</div>
						</div>
					</div>
				...
				<?php if ($b->nama == 'clamp pipe') : ?>
					<div class="col-md-6">
						<div class="card card-info">
								...
								<table id="example8" class="table table-hover table-sm">
									...
									foreach ($query->result() as $p) { ?>
										<tr style="text-align:center">
											...
											<td><?php echo strtoupper($p->nama) ?></td>
											<td>
												<a class="btn-sm btn-warning" data-toggle="modal" data-target="#hole_edit<?php echo $p->id; ?>" title="Edit"><i class="fa fa-edit"></i></a>
												<a class="btn-sm btn-danger" data-toggle="modal" data-target="#hole_del<?php echo $p->id; ?>" title="Delete"><i class="fa fa-trash"></i></a>
											</td>
										</tr>
									<?php } ?>
								</table>
							...
							<div class="card-body row">
								<div class="col-md-4">
									<button class="btn btn-success btn-block" data-toggle="modal" data-target="#hole_add" title="Add"><i class="fa fa-plus"></i> Add New Hole</button>
								</div>
							</div>
						</div>
					</div>
								...
								<table id="example9" class="table table-hover table-sm">
									...
									foreach ($query->result() as $p) { ?>
										<tr style="text-align:center">
											...
											<td><?php echo strtoupper($p->nama) ?></td>
											<td>
												<a class="btn-sm btn-warning" data-toggle="modal" data-target="#id_edit<?php echo $p->id; ?>" title="Edit">
													<i class="fa fa-edit"></i></a>
												<a class="btn-sm btn-danger" data-toggle="modal" data-target="#id_del<?php echo $p->id; ?>" title="Delete">
													<i class="fa fa-trash"></i></a>
											</td>
										</tr>
									<?php } ?>
				...
				<?php if ($b->nama == 'clamp pipe') : ?>
					<div class="col-md-6">
						<div class="card card-info">
								...
								<table id="example10" class="table table-hover table-sm">
									...
									foreach ($query->result() as $p) { ?>
										<tr style="text-align:center">
											...
											<td><?php echo strtoupper($p->nama) ?></td>
											<td>
												<a class="btn-sm btn-warning" data-toggle="modal" data-target="#plat_edit<?php echo $p->id; ?>" title="Edit"><i class="fa fa-edit"></i></a>
												<a class="btn-sm btn-danger" data-toggle="modal" data-target="#plat_del<?php echo $p->id; ?>" title="Delete"><i class="fa fa-trash"></i></a>
											</td>
										</tr>
									<?php } ?>
								</table>
							...
							<div class="card-body row">
								<div class="col-md-4">
									<button class="btn btn-success btn-block" data-toggle="modal" data-target="#plat_add" title="Add"><i class="fa fa-plus"></i> Add New Plat</button>
								</div>
							</div>
						</div>
					</div>
								...
								<table id="example11" class="table table-hover table-sm">
									...
									foreach ($query->result() as $p) { ?>
										<tr style="text-align:center">
											...
											<td><?php echo strtoupper($p->nama) ?></td>
											<td>
												<a class="btn-sm btn-warning" data-toggle="modal" data-target="#thread_edit<?php echo $p->id; ?>" title="Edit">
													<i class="fa fa-edit"></i></a>
												<a class="btn-sm btn-danger" data-toggle="modal" data-target="#thread_del<?php echo $p->id; ?>" title="Delete">
													<i class="fa fa-trash"></i></a>
											</td>
										</tr>
									<?php } ?>
