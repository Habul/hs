					...
					<div class="card card-success">
						...
						if(isset($_GET['alert'])){
							if($_GET['alert'] == "sukses"){
								echo "<div class='alert alert-success' id='info'>Password telah diubah!</div>";
							}else if($_GET['alert'] == "gagal"){
								echo "<div class='alert alert-danger' id='info'>Maaf, password lama yang anda masukkan salah!</div>";
							}
						}
						?>
