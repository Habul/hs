						...
						<form method="post" action="<?php echo base_url('dashboard/pengaturan_update') ?>"
							...
							<div class="card-body">
								<div class="form-group">
									...
									<input type="text" name="nama" class="form-control" placeholder="Masukkan nama website.."
								...
								<div class="form-group">
									...
									<input type="text" name="link_facebook" class="form-control"
										placeholder="Masukkan link facebook .." value="<?php echo $p->link_facebook; ?>">
								...
								<div class="form-group">
									...
									<input type="text" name="link_twitter" class="form-control"
										placeholder="Masukkan link_twitter .." value="<?php echo $p->link_twitter; ?>">
								...
								<div class="form-group">
									...
									<input type="text" name="link_instagram" class="form-control"
										placeholder="Masukkan link_instagram .." value="<?php echo $p->link_instagram; ?>">
								...
								<div class="form-group">
									...
									<input type="text" name="link_github" class="form-control"
										placeholder="Masukkan link_github .." value="<?php echo $p->link_github; ?>">
