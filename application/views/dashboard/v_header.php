...
<head>
	...
	<link rel="stylesheet" href="<?= base_url(); ?>assets/dist/css/style_games.css">
</head>
	...
	<div class="wrapper">
		...
		<nav class="main-header navbar navbar-expand navbar-light navbar-light">
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="<?= base_url() . 'dashboard' ?>" <?= $this->uri->uri_string() == 'dashboard'
																				|| $this->uri->uri_string() == '' ? 'class="nav-link active"' : 'class="nav-link"' ?>>Dashboard</a>
				</li>
				<li class="nav-item d-none d-sm-inline-block">
					<a href="<?= base_url() . 'dashboard/profil' ?>" <?= $this->uri->uri_string() == 'dashboard/profil'
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item dropdown user-menu">
					<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
						<img src="<?= base_url() . 'gambar/profile/' . $this->session->userdata('foto'); ?>" class="user-image img-circle elevation-2" alt="User Image">
						<span class="d-none d-md-inline"><?= $this->session->userdata('nama'); ?>&nbsp;<i class="fas fa-angle-down right"></i>
					</a>
					<ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
						<li class="user-header">
							<img src="<?= base_url() . 'gambar/profile/' . $this->session->userdata('foto'); ?>" class="img-circle elevation-2" alt="User Image">
							<p>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			<a href="#" class="brand-link">
				<img src="<?= base_url(); ?>gambar/website/hs-logo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-2">
			...
			<div class="sidebar">
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					...
					<div class="info">
						<a href="<?= base_url() . 'dashboard/profil' ?>" class="d-block"><?= $this->session->userdata('nama');  ?></a>
					</div>
				</div>
				...
				<nav class="mt-2">
					<ul class="nav nav-pills nav-sidebar nav-child-indent nav-compact flex-column" data-widget="treeview" role="menu" data-accordion="false">
						<li class="nav-item">
							<a href="<?= base_url() . 'dashboard' ?>" <?= $this->uri->uri_string() == 'dashboard' || $this->uri->uri_string() == '' ? 'class="nav-link active"' : 'class="nav-link"' ?>>
						...
						<?php if ($this->session->userdata('level') == "admin" || $this->session->userdata('level') == "mgr") {  ?>
							<li class="nav-item">
								<a href="<?= base_url() . 'dashboard/pengguna' ?>" <?= $this->uri->uri_string() == 'dashboard/pengguna' || $this->uri->uri_string() == '' ? 'class="nav-link active"' : 'class="nav-link"' ?>>
									<i class="nav-icon fas fa-users"></i>
									<p>User & User Access</p>
								</a>
							</li>
							<li class="nav-item">
								<a href="<?= base_url() . 'sj/sj' ?>" <?= $this->uri->uri_string() == 'sj/sj' ||
						...
						<li <?= $this->uri->segment(2) == 'listing' ||
							...
							<a href="#" <?= $this->uri->segment(2) == 'listing' ||
								...
								<?php if ($total != 0) : ?>
									<span class="badge badge-warning right"><?= $total; ?></span>
								<?php endif; ?>
								<p>Listing
							...
							<ul class="nav nav-treeview">
								<li class="nav-item">
									<a href="<?= base_url() . 'listing/listing_item' ?>" <?= $this->uri->segment(2) == 'listing_item' ||
																												$this->uri->segment(2) == 'listing_item_detail' ||
																												$this->uri->uri_string() == '' ? 'class="nav-link active"' : 'class="nav-link"' ?>>
								...
								<li class="nav-item">
									<a href="<?= base_url() . 'listing/listing_price' ?>" <?= $this->uri->segment(2) == 'listing_price' ||
																												$this->uri->segment(2) == 'listing_price_detail' ||
																												$this->uri->uri_string() == '' ? 'class="nav-link active"' : 'class="nav-link"' ?>>
								...
								<li class="nav-item">
									<a href="<?= base_url() . 'listing/listing' ?>" <?= $this->uri->segment(2) == 'listing' ||
																										$this->uri->segment(2) == 'list_update' ||
																										$this->uri->segment(2) == 'new_list' ||
																										$this->uri->segment(2) == 'search' ||
																										$this->uri->segment(2) == 'list' ||
						...
						<li class="nav-item">
							<a href="<?= base_url() . 'dashboard/contact' ?>" <?= $this->uri->uri_string() == 'dashboard/contact' || $this->uri->uri_string() == '' ? 'class="nav-link active"' : 'class="nav-link"' ?>>
